...
abstract class _MarkerControllerBase with Store {
  ...
  @observable
  TypeMarkerModel selectedMarker;
  ...
  @action
  setSelectedMarker(TypeMarkerModel value) => selectedMarker = value;

  @observable
  ObservableList<DropdownMenuItem<TypeMarkerModel>> dropdownMenuItems =
      ObservableList();

  @observable
  DropdownMenuItem<TypeMarkerModel> dropdownMenuValue;
