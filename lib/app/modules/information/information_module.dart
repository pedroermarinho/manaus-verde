...
import 'package:manaus_verde/app/modules/information/repositories/comment/repository/comment_repository.dart';
import 'package:manaus_verde/app/modules/information/repositories/stars/repository/stars_repository.dart';
...
class InformationModule extends WidgetModule {
  ...
  List<ModularRouter> get routers => [
    ModularRouter(Modular.initialRoute, child: (_, args) => InformationPage()),
      ];
